    ...
    <div
      ...
      <div
        className={`fixed right-0 top-0 
          flex flex-col gap-2 justify-between w-full sm:w-1/3 h-full py-8 px-3
        ...
        <ul className="p-2 h-2/3 space-y-2 sm:space-y-4 overflow-y-scroll scrollbar-hide">
          ...
          <li
            className="grid grid-cols-3 p-2 gap-3 
              items-center justify-items-center bg-gray">
            ...
            <div className="flex flex-col items-center">
              ...
              <i className="ri-delete-bin-3-fill text-yellow text-2xl"></i>
            </div>
          </li>
        ...
        <div className="flex justify-between items-center font-bold text-lgt">
          <span>Sub Total</span>
          <span>Rs. 809</span>
        </div>
